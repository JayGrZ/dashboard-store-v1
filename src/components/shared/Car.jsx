  ...
  return (
    <div className={`lg:col-span-2 fixed top-0 bg-[#1F1D2B] w-full lg:w-96 lg:right-0 h-full transition-all z-50 ${showOrder ? 'right-0' : '-right-full'}`}>
        ...
        <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
          ...
          <h1 className="text-2xl mt-4 my-4">Orders #151416</h1>
          {/* Pills */}
          <div className="flex items-center gap-4 flex-wrap mb-8">
            <button className="bg-[#ec7c6a] text-white py-2 px-4 rounded-xl">Dine in</button>
            <button className="text-[#ec7c6a] py-2 px-4 rounded border border-gray-500">To go</button>
            <button className="text-[#ec7c6a] py-2 px-4 rounded border border-gray-500">Delivery</button>
          </div>
          {/* Car */}
          <div>
              ...
              <div className="bg-[#262837] p-4 rounded-xl mb-4">
                <div className="grid grid-cols-6 mb-2">
                  ...
                  <div className="col-span-4 flex items-center gap-3">
                    <img src="Curry.png" className="w-10 h-10 object-cover" />
                    <div>
                      <h5 className="text-sm">Spicy Curry</h5>
          ...
          {/* Submit Payment */}
          <div className="absolute bg-[#262837] bottom-0 left-0 p-4 w-full">
            ...
            <div>
              <button className="bg-[#ec7c6a] w-full py-2 px-4 rounded-lg text-white">Continue to payment</button>
            </div>
          </div>
        </div>
      </div>
